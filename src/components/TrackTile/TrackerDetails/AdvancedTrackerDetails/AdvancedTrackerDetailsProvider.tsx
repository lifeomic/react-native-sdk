...
export type AdvancedTrackerDetailsProviderProps = AdvancedTrackerDetailsProps & {
  styles?: Styles;
  trackTileService: TrackTileService;
  fonts?: FontWeights;
};

export const AdvancedTrackerDetailsProvider: FC<AdvancedTrackerDetailsProviderProps> = (
  props
) => {
